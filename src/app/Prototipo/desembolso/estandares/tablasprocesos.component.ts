...
@Component({
  ...
  templateUrl: './tablasprocesos.component.html',  // Enlaza la plantilla HTML del componente
  styleUrl: './tablasprocesos.component.scss',   // Enlaza el archivo de estilos SCSS del componente
  standalone: true,
  providers: [MessageService, ConfirmationService], // Asegurar que MessageService esté disponible
})

export class tablasprocesos implements OnInit {
