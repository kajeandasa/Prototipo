...
@Component({
  ...
  templateUrl: './tablasmantenimiento.component.html',  // Enlaza la plantilla HTML del componente
  styleUrl: './tablasmantenimiento.component.scss',   // Enlaza el archivo de estilos SCSS del componente
  standalone: true,
  providers: [MessageService, ConfirmationService], // Asegurar que MessageService esté disponible
})
export class tablasmantenimiento {

  // Array con los datos de la tabla tipo de beca
  tasks = [
    {
        id: 1,
