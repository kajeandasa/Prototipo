...
@Component({
  ...
  templateUrl: './soliprorroga.component.html',  // Enlaza la plantilla HTML del componente
  styleUrl: './soliprorroga.component.scss',   // Enlaza el archivo de estilos SCSS del componente
  standalone: true,
  providers: [MessageService, ConfirmationService], // Asegurar que MessageService esté disponible
})
export class solicitudProrrogaComponent { 
