...
@Component({
  ...
  templateUrl: './tipobeca.component.html',  // Enlaza la plantilla HTML del componente
  styleUrl: './tipobeca.component.scss',   // Enlaza el archivo de estilos SCSS del componente
  standalone: true,
