...
@Component({
  ...
  templateUrl: './plazoprorroga.component.html',  // Enlaza la plantilla HTML del componente
  styleUrl: './plazoprorroga.component.scss',   // Enlaza el archivo de estilos SCSS del componente
  standalone: true,
  providers: [MessageService, ConfirmationService], // Asegurar que MessageService esté disponible
})
export class plazoProrrogaComponent {

  // Array con los datos de la tabla plazos
  tasks = [
    {
        id: 1,
