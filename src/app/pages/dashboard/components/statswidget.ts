...
// informacion de becas
    ...
    BecasGradoPregrado = {
        ...
        description: 'La beca básica de grado se otorga a estudiantes de pregrado de la UNAH que forman parte de un grupo de investigación o son invitados a un equipo de investigación de una beca sustantiva. Estos espacios sirven para aprender el método científico, y los estudiantes deben tener roles y responsabilidades asignadas. La beca está diseñada para enseñar a investigar, integrando a los alumnos en proyectos generales con un plan de trabajo aprobado.',
        files: [
            { name: 'Convocatoria.pdf', url: '/assets/docs/convocatoria_fondos.pdf' }
        ]
    };
